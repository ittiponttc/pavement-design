...
"""
================================================================================
โปรแกรมวิเคราะห์ต้นทุนตลอดอายุการใช้งานผิวทาง (LCCA) - เวอร์ชัน 1.0
...
คุณสมบัติเวอร์ชัน 1.0:
- ใส่ต้นทุนก่อสร้างได้เอง
...
def สร้างทางเลือกเริ่มต้น() -> List[ทางเลือกผิวทาง]:
    ...
    jpcp = ทางเลือกผิวทาง(
        ...
        แผนฟื้นฟูสภาพ=[
            กิจกรรมฟื้นฟูสภาพ("ขัดผิวหน้า (Diamond Grinding)", 180.0, ปีดำเนินการ=20),
    ...
    jrcp = ทางเลือกผิวทาง(
        ...
        แผนบำรุงรักษา=[
            ...
            กิจกรรมบำรุงรักษา("ซ่อมเต็มความลึก", 70.0, ปีเริ่มต้น=18, ความถี่=18),
        ],
        แผนฟื้นฟูสภาพ=[
            กิจกรรมฟื้นฟูสภาพ("ขัดผิวหน้า (Diamond Grinding)", 180.0, ปีดำเนินการ=22),
            กิจกรรมฟื้นฟูสภาพ("ปูทับ AC 100 มม.", 550.0, ปีดำเนินการ=32),
        ],
    ...
    crcp = ทางเลือกผิวทาง(
        ...
        แผนฟื้นฟูสภาพ=[
            กิจกรรมฟื้นฟูสภาพ("ขัดผิวหน้า (Diamond Grinding)", 180.0, ปีดำเนินการ=25),
...
def main():
    ...
    st.markdown("""
    **Life-Cycle Cost Analysis for Pavement Alternatives - Version 1.0**
    
    สำหรับการเรียนการสอนและงานวิจัยด้านวิศวกรรมทาง  
    
    
    ✨ **พัฒนาโดย รศ.ดร.อิทธิพล มีผล // ภาควิชาครุศาสตร์โยธา // มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ 
    """)
    ...
    st.markdown("""
    ---
    **โปรแกรมวิเคราะห์ LCCA ผิวทาง v1.0** | พัฒนาสำหรับการเรียนการสอนด้านวิศวกรรมทาง  
    ภาควิชาครุศาสตร์โยธา มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
    """)
