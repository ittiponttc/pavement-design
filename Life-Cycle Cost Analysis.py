...
def สร้างทางเลือกเริ่มต้น() -> List[ทางเลือกผิวทาง]:
    ...
    flexible = ทางเลือกผิวทาง(
        ...
        แผนบำรุงรักษา=[
            ...
            กิจกรรมบำรุงรักษา("Overlay", 150.0, ปีเริ่มต้น=9, ความถี่=9),
        ],
        แผนฟื้นฟูสภาพ=[
            กิจกรรมฟื้นฟูสภาพ("ก่อสร้าง AC ใหม่", 450.0, ปีดำเนินการ=20),
            กิจกรรมฟื้นฟูสภาพ("ไส+ปูทับ AC 80 มม.", 650.0, ปีดำเนินการ=20),
        ],
