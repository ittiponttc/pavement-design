...
Pi = st.sidebar.slider(
    ...
    help="ค่าความสามารถในการให้บริการเริ่มต้น ค่าแนะนำ 4.2"
)
pt = st.sidebar.slider(
    "Terminal Serviceability (pₜ)",
    min_value=2.0, max_value=3.0, value=2.5, step=0.1,
    help="ค่าความสามารถในการให้บริการสิ้นสุดปริมาณจราจรมากแนะนำ 2.5 ปริมาณจราจรน้อยแนะนำ 2.0"
)
delta_PSI = Pi - pt
...
<div style='text-align: center; color: #666;'>
    ...
    <p>รศ.ดร.อิทธิพล มีผล ภาควิชาครุศาสตร์โยธา มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ</p>
</div>
""", unsafe_allow_html=True)
